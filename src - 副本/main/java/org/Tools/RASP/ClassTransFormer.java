    ...
    public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined,
        ...
        try {
            if (className!=null&&className.equalsIgnoreCase("java/rmi/server/RemoteObjectInvocationHandler")){
                ...
                Constructor<?> ctor = Class.forName("afanti.rasp.visitor.RemoteObjectInvocationHandlerHookVisitor").
                        getDeclaredConstructor(new Class[]{ClassVisitor.class, String.class});
